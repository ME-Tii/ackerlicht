  ...
  const template = [
      ...
      },
      {
        ...
        submenu: [
          ...
          { label: "Gruppieren", click: send("group") },
          ...
          { label: "90° drehen", click: send("rot-90") },
          ...
          { type: "separator" },
          { label: "Letzte Aktion wiederholen", accelerator: "CmdOrCtrl+R", registerAccelerator: false, click: send("repeat") },
