...
function openPlannerWindow(port) {
  ...
  const win = new BrowserWindow({
    ...
    minWidth: 800,
    minHeight: 560,
    title: "Ackerlicht Gartensoftware 128",
  ...
  const template = [
      ...
      },
      {
        ...
        submenu: [
          ...
          { label: "Kalibrierlinie (Maßstab)…", click: send("calib") },
          { label: "Grundriss…", click: send("grundriss") },
          { label: "Neuer Grundriss…", click: send("grundriss-new") },
          { label: "Fläche füllen…", click: send("bedfill") },
      ...
      },
      {
        ...
        submenu: [
          ...
          { label: "Erlös / Gewinn", click: send("kz-yield") },
